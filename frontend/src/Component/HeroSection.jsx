...
const HeroSection = () => {
  ...
  return (
    <div className='flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
         ...
         <p className='max-w-md text-gray-300' >Guardians of the Galaxy follows a group of unlikely space outlaws led by Peter Quill who team up to stop a powerful villain threatening the galaxy. </p>
